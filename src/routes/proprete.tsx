...
export const Route = createFileRoute("/proprete")({
  ...
  component: () => (
    <ServicePage
      ...
      image={img}
      features={[
        { title: "Nettoyage tertiaire", description: "Entretien quotidien et hebdomadaire des bureaux, espaces communs, sanitaires et salles de réunion selon vos protocoles." },
