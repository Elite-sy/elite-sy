...
export const Route = createFileRoute("/mentions-legales")({
  head: () => ({
    meta: [
      { title: "Mentions légales — ELITESY" },
      { name: "description", content: "Mentions légales, politique de confidentialité et conditions d'utilisation du site ELITESY." },
      { property: "og:title", content: "Mentions légales — ELITESY" },
      { property: "og:description", content: "Mentions légales, politique de confidentialité et conditions d'utilisation du site ELITESY." },
      { property: "og:url", content: "https://elite-sy.lovable.app/mentions-legales" },
    ],
    links: [{ rel: "canonical", href: "https://elite-sy.lovable.app/mentions-legales" }],
  }),
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-10">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              La société <strong>ELITESY</strong>, soucieuse des droits des individus, notamment au regard des traitements automatisés et dans une volonté de transparence avec ses clients, a mis en place une politique reprenant l'ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d'actions à la disposition des individus afin qu'ils puissent au mieux exercer leurs droits.
            </p>
          ...
          <div className="mt-16 space-y-16">
            <Article title="Article 1 — Mentions légales">
              <SubSection title="1.1 Site (ci-après « le site »)">
                <p className="text-muted-foreground">ELITESY</p>
              </SubSection>
              <SubSection title="1.2 Éditeur (ci-après « l'éditeur »)">
                <p className="text-muted-foreground"><strong>ELITE NET</strong></p>
                <p className="text-muted-foreground mt-2">dont le siège social est situé : 94600 CHOISY-LE-ROI</p>
                ...
                <p className="text-muted-foreground mt-2">n° de téléphone : +33 6 09 16 50 99</p>
                <p className="text-muted-foreground mt-2">
                  adresse mail :{" "}
                  <a href="mailto:contact@elitesy.fr" className="text-primary hover:underline">contact@elitesy.fr</a>
                </p>
              </SubSection>
              <SubSection title="1.3 Hébergeur (ci-après « l'hébergeur »)">
                <p className="text-muted-foreground">
                  Le site ELITESY est hébergé par Vercel Inc., dont le siège social est situé 340 S Lemon Ave #4133, Walnut, CA 91789, USA.
                </p>
              </SubSection>
            </Article>
            ...
            <Article title="Article 3 — Contenu du site">
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Article title="Article 4 — Gestion du site">
              <p className="text-muted-foreground leading-relaxed">Pour la bonne gestion du site, l'éditeur pourra à tout moment :</p>
            ...
            <Article title="Article 5 — Responsabilités">
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Article title="Article 6 — Liens hypertextes">
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Article title="Article 7 — Collecte et protection des données">
              <p className="text-muted-foreground leading-relaxed">
                Vos données sont collectées par la société <strong>ELITESY</strong>.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Les informations personnelles pouvant être recueillies sur le site sont principalement utilisées par l'éditeur pour la gestion des relations avec vous, et le cas échéant pour le traitement de vos demandes de devis.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">Les données personnelles collectées sont les suivantes :</p>
              <ul className="mt-3 space-y-2 text-muted-foreground list-disc list-inside">
                <li>nom et prénom</li>
                <li>adresse</li>
                <li>adresse mail</li>
            ...
            <Article title="Article 8 — Droit d'accès, de rectification et de déréférencement de vos données">
              <p className="text-muted-foreground leading-relaxed">
                En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits suivants :
              </p>
              <ul className="mt-4 space-y-3 text-muted-foreground list-disc list-inside">
                <li><strong>le droit d'accès</strong> : ils peuvent exercer leur droit d'accès, pour connaître les données personnelles les concernant, en écrivant à l'adresse électronique ci-dessous mentionnée. Dans ce cas, avant la mise en œuvre de ce droit, la Plateforme peut demander une preuve de l'identité de l'utilisateur afin d'en vérifier l'exactitude ;</li>
                ...
                <li><strong>le droit à la limitation du traitement</strong> : les utilisateurs peuvent demander à la Plateforme de limiter le traitement des données personnelles conformément aux hypothèses prévues par le RGPD ;</li>
              ...
              <p className="text-muted-foreground leading-relaxed mt-6">
                Vous pouvez exercer ce droit en nous contactant, par email, à l'adresse :{" "}
                <a href="mailto:contact@elitesy.fr" className="text-primary hover:underline">contact@elitesy.fr</a>
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                <a href="https://www.cnil.fr/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://www.cnil.fr</a>.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
            ...
            <Article title="Article 9 — Utilisation des données">
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Article title="Article 10 — Politique de conservation des données">
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Article title="Article 11 — Partage des données personnelles avec des tiers">
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Article title="Article 12 — Offres commerciales">
              <p className="text-muted-foreground leading-relaxed">
                Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez nous contacter à l'adresse :{" "}
                <a href="mailto:contact@elitesy.fr" className="text-primary hover:underline">contact@elitesy.fr</a>.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
            ...
            <Article title="Article 13 — Cookies">
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">La durée de vie de ces cookies est de treize mois.</p>
            </Article>

            <Article title="Article 14 — Photographies et représentations">
              <p className="text-muted-foreground leading-relaxed">
                Les photographies et visuels accompagnant les descriptions sur le site ne sont pas contractuels et n'engagent pas l'éditeur.
              </p>
            </Article>

            <Article title="Article 15 — Loi applicable">
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Article title="Article 16 — Contactez-nous">
              <p className="text-muted-foreground leading-relaxed">
                Pour toute question, information ou réclamation sur les présentes conditions d'utilisation ou sur la politique de confidentialité, vous pouvez nous contacter à l'adresse suivante :
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
                <strong>Email :</strong>{" "}
                <a href="mailto:contact@elitesy.fr" className="text-primary hover:underline">contact@elitesy.fr</a>
